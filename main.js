...
document.querySelector('#cards').innerHTML =  
        ...
        createCard('23/11', 'quarta', createGame('marocco', '07:00', 'croatia') + createGame('germany', '10:00', 'japan') + createGame('spain', '15:00', 'costa-rica') + createGame('belgium', '16:00', 'canada')) +
